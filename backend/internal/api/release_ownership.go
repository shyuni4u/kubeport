...
func (h *Handlers) checkOwnership(c *gin.Context, cli K8sApplier, op, namespace, release, releaseUID string, rendered []byte) bool {
	...
	check, err := cli.CheckApply(c.Request.Context(), namespace, release, releaseUID, rendered, !update)
