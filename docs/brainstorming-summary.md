...
| 데모 네임스페이스 한도 (#348 #350) | 데모 호출자에게만 적용(`demo.policy`). Job backoff 2·TTL 86400·CronJob 이력 1, ephemeral-storage 상한. 이미지 허용목록은 기본 빈 값(끔), 라이브도 끔 | §14 — 셀프호스팅 기본값에 데모 제한을 섞지 않는다 (#351 #352 #353) |
